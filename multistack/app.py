...
ipstack = 'Ipv4'
app = core.App()
VPCStack = VPC(app, "MY-VPC", env=myenv, res = 'vpcpub', cidrid = 0, natgw = 0, maxaz = 1, ipstack = ipstack)
...
ASGStack = asg(app, "MY-ASG", env=myenv, res = 'bastioncdk', preflst = True, allowall = '', ipstack = ipstack, allowsg = '', vpc = VPCStack.vpc)
