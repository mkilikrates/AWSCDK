...
EKStack = eks(app, "myeks", env=myenv, res = 'myeksprivec2', preflst = False, allowsg = BationStack.bastionsg, allowall = '', ipstack = ipstack, vpc = VPCStack.vpc)
EKSAppStack = eksapp(app, "nginxs3", env=myenv, res = 'eksalbfe', preflst = False, allowsg = BationStack.bastionsg, allowall = 443, ekscluster = EKStack.eksclust, ipstack = ipstack, vpc = VPCStack.vpc)
app.synth()
