...
GatewayStack = mygw(app, "MY-GATEWAY", env=myenv, gwtype = gwtype, gwid = '', res = 'tgwnetfw', route = route, ipstack = ipstack, vpc = VPCStack.vpc, vpcname = 'inspectvpc', bastionsg = '')
VPCStack2 = VPC(app, "MY-VPC2", env=myenv, res = 'vpcsec', cidrid = 1, natgw = 0, maxaz = 3, ipstack = ipstack)
GatewayStack2 = mygw(app, "MY-GATEWAY2", env=myenv, gwtype = gwtype, gwid = 'tgw-026aa30aa18280d8d', res = 'tgwnetfw', route = route, ipstack = ipstack, vpc = VPCStack2.vpc, vpcname = 'vpcsec', bastionsg = '')
VPCStack3 = VPC(app, "MY-VPC3", env=myenv, res = 'vpcsec', cidrid = 2, natgw = 0, maxaz = 3, ipstack = ipstack)
GatewayStack3 = mygw(app, "MY-GATEWAY3", env=myenv, gwtype = gwtype, gwid = 'tgw-026aa30aa18280d8d', res = 'tgwnetfw', route = route, ipstack = ipstack, vpc = VPCStack3.vpc, vpcname = 'vpcsec', bastionsg = '')
