...
ipstack = 'Ipv6'
app = core.App()
VPCStack = VPC(app, "MY-VPC", env=myenv, res = 'netfwsinglevpc', cidrid = 0, natgw = 3, maxaz = 3, ipstack = ipstack)
...
#ASGStack = asg(app, "MY-ASG", env=myenv, res = 'nginxbe', preflst = True, allowall = '', ipstack = ipstack, allowsg = '', vpc = VPCStack.vpc)
...
#CVPNStack = cvpn(app, "MY-CVPN", env=myenv, res = 'cvpn', auth = ['mutual', 'federated'], vpc = VPCStack.vpc, dirid = '')
