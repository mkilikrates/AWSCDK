...
GatewayStack3 = mygw(app, "MY-GATEWAY3", env=myenv, gwtype = gwtype, gwid = '', res = 'tgwnetfw', route = route, ipstack = ipstack, vpc = VPCStack3.vpc, vpcname = 'vpcsec', bastionsg = '', tgwstack = GatewayStack, cross = False)
...
#GatewayStack4 = mygw(app, "MY-GATEWAY4", env=myenv, gwtype = gwtype, gwid = 'tgw-0016e0d1d5f939326', res = 'tgwnetfw', route = route, ipstack = ipstack, vpc = VPCStack4.vpc, vpcname = 'vpcsec', bastionsg = '', tgwstack = '', cross = True)
